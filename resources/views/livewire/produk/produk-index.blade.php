...
<div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        {{-- <button wire:click="getProduk({{$data->id}})" class="btn btn-sm btn-info
    ...
    @foreach ($produk as $d)
    <!-- Modal -->
    <div wire:ignore.self class="modal fade" id="exampleModal{{$d->id}}" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" wire:click.prevent="destroy({{$d->id}})" class="btn btn-danger close-modal"
