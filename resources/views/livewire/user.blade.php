            ...
            <table class="table table-bordered table-hover table-striped table-sm">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <button wire:click.prevent="DetailData({{ $data->id }})" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#edituser"><i class="far fa-edit"></i></button>
                        <button wire:click.prevent="DetailData({{ $data->id }})" class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteuser"><i class="far fa-trash-alt"></i></button>
                    </td>
                  </tr>
                  @endforeach
                </tbody>
